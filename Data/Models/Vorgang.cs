...
namespace Lieferliste_WPF.Data.Models
{
    ...
    public partial class Vorgang
    {
        ...
        public virtual TblAuftrag AidNavigation { get; set; } = null!;
        [ForeignKey(nameof(ArbPlSap))]
        [InverseProperty(nameof(WorkSap.Vorgangs))]
        public virtual WorkSap? ArbPlSapNavigation { get; set; }
        [ForeignKey(nameof(Rid))]
        [InverseProperty(nameof(Ressource.Vorgangs))]
